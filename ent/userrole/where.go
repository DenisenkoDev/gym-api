...
func IsCloseEQ(v bool) predicate.UserRole {
	return predicate.UserRole(sql.FieldEQ(FieldIsClose, v))
}

// IsCloseNEQ applies the NEQ predicate on the "is_close" field.
func IsCloseNEQ(v bool) predicate.UserRole {
	return predicate.UserRole(sql.FieldNEQ(FieldIsClose, v))
}

// HasGym applies the HasEdge predicate on the "gym" edge.
func HasGym() predicate.UserRole {
...
func HasGymWith(preds ...predicate.Gym) predicate.UserRole {
	return predicate.UserRole(func(s *sql.Selector) {
		step := newGymStep()
