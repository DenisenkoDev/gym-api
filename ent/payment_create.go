...
func (pc *PaymentCreate) SetLinkPhoto(s string) *PaymentCreate {
	pc.mutation.SetLinkPhoto(s)
	return pc
}

// SetNillableLinkPhoto sets the "link_photo" field if the given value is not nil.
func (pc *PaymentCreate) SetNillableLinkPhoto(s *string) *PaymentCreate {
	if s != nil {
		pc.SetLinkPhoto(*s)
	}
	return pc
...
func (pc *PaymentCreate) SetConfirmedAt(t time.Time) *PaymentCreate {
	pc.mutation.SetConfirmedAt(t)
	return pc
}

// SetNillableConfirmedAt sets the "confirmed_at" field if the given value is not nil.
func (pc *PaymentCreate) SetNillableConfirmedAt(t *time.Time) *PaymentCreate {
	if t != nil {
		pc.SetConfirmedAt(*t)
	}
	return pc
...
func (pc *PaymentCreate) SetIsConfirmed(b bool) *PaymentCreate {
	pc.mutation.SetIsConfirmed(b)
	return pc
}

// SetNillableIsConfirmed sets the "is_confirmed" field if the given value is not nil.
func (pc *PaymentCreate) SetNillableIsConfirmed(b *bool) *PaymentCreate {
	if b != nil {
		pc.SetIsConfirmed(*b)
	}
	return pc
...
func (pc *PaymentCreate) SetAbonementID(id int) *PaymentCreate {
	pc.mutation.SetAbonementID(id)
	return pc
}

// SetAbonement sets the "abonement" edge to the Abonement entity.
func (pc *PaymentCreate) SetAbonement(a *Abonement) *PaymentCreate {
	return pc.SetAbonementID(a.ID)
}
...
func (pc *PaymentCreate) defaults() {
	...
	if _, ok := pc.mutation.IsConfirmed(); !ok {
		v := payment.DefaultIsConfirmed
		pc.mutation.SetIsConfirmed(v)
	}
}
...
func (pc *PaymentCreate) check() error {
	...
	if _, ok := pc.mutation.IsConfirmed(); !ok {
		return &ValidationError{Name: "is_confirmed", err: errors.New(`ent: missing required field "Payment.is_confirmed"`)}
	}
	if len(pc.mutation.AbonementIDs()) == 0 {
		return &ValidationError{Name: "abonement", err: errors.New(`ent: missing required edge "Payment.abonement"`)}
	}
	return nil
}
...
func (pc *PaymentCreate) createSpec() (*Payment, *sqlgraph.CreateSpec) {
	...
	if nodes := pc.mutation.AbonementIDs(); len(nodes) > 0 {
		...
		_node.payment_abonement = &nodes[0]
