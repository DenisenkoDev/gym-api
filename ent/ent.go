...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			abonementtype.Table:    abonementtype.ValidColumn,
			credential.Table:       credential.ValidColumn,
			gym.Table:              gym.ValidColumn,
			managerrole.Table:      managerrole.ValidColumn,
			payment.Table:          payment.ValidColumn,
			paymentrequisite.Table: paymentrequisite.ValidColumn,
			usagemode.Table:        usagemode.ValidColumn,
